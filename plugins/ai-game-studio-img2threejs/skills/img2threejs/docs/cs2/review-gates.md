...
```text
<python> "<skill-root>/forge/stage4_review/append_review.py" object-sculpt-spec.json
  --pass-id material-pass --fidelity 0.9 --action continue --summary "knife review passed"
  --cs2-review-json cs2-review.json
  --review-scene-json "<skill-root>/forge/tests/fixtures/knife_review_scene.json" --in-place
```
